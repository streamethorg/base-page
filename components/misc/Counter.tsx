...
const Counter = ({
  ...
  return (
    <div className="flex z-10 flex-row justify-between items-center md:p-0">
      <div className="flex flex-col justify-center items-center w-full bg-black md:rounded-xl aspect-video md:w-[550px]">
